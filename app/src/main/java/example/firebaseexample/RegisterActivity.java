...
public class RegisterActivity extends AppCompatActivity {
    ...
    TextInputEditText email,pass,name,mob,age;
    Button signup;
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(email.getText().length() != 0 && pass.getText().length() != 0 && name.getText().length() != 0 && mob.getText().length() != 0 && !filechoosed && age.getText().length()!=0){
                    if(Integer.parseInt(age.getText().toString())<0 || Integer.parseInt(age.getText().toString())>150){
                        Toast.makeText(RegisterActivity.this, "Please Enter Valid Age", Toast.LENGTH_SHORT).show();
                        return;
                    }
                            ...
                            .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        User newUser = new User(id,name.getText().toString(),mob.getText().toString(),email.getText().toString(),downloadUrl,Integer.parseInt(age.getText().toString()) );
...
//                imageView.setImageBitmap(bitmap);
    ...
    private void uploadImage(){
        ...
        dialog = ProgressDialog.show(RegisterActivity.this, "Image Upload",
